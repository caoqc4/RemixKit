...
4. Add a local-to-public media bridge.
   - Needed for Luma and any provider requiring HTTPS URLs.
   - Could be a user-provided `PUBLIC_MEDIA_BASE_URL`, local tunnel, or object storage adapter.
